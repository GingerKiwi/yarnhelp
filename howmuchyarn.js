...
calculateBtn.addEventListener("click", function() {
   ...
   // --- PULLOVER SWEATERS ---
    ...
    `You need ${Number(Math.ceil(800 * 1.05/yardsPerBall.value))} balls of this yarn for a toddler pullover`
    childPulloverAnswer.innerHTML = 
    `You need ${Number(Math.ceil(1200 * 1.05/yardsPerBall.value))} balls of this yarn for a child`
    
    // Adults //
    adult1PulloverAnswer.innerHTML = 
    `You need ${Number(Math.ceil(1400 * 1.05/yardsPerBall.value))} balls of this yarn for a women's pullover`
    adult2PulloverAnswer.innerHTML = 
    `You need ${Number(Math.ceil(1700* 1.05/yardsPerBall.value))} balls of this yarn for a men's pullover`
